...
export function HomeScreen({ onNavigate }: HomeScreenProps) {
  const { currentUser, logout, getBalance } = useChatterStore();
      ...
      <main className="relative z-10 flex-1 flex flex-col items-center justify-center px-6 py-8">
        ...
        >
          <div className="relative mb-4">
            ...
            />
            <div
              className="absolute -bottom-1 -right-1 rounded-full px-2 py-0.5 text-[10px] font-bold uppercase tracking-wider"
              style={{
          ...
          <p className="text-xs mt-1" style={{ color: "oklch(0.55 0.04 255)" }}>
            {currentUser.city} · {currentUser.occupation}
          </p>
        </motion.div>
        ...
        <div className="w-full max-w-sm space-y-4">
          ...
          <motion.button
            ...
            style={{
              background:
                "linear-gradient(135deg, oklch(0.38 0.1 220), oklch(0.3 0.08 250))",
              border: "1px solid oklch(0.5 0.12 220 / 0.6)",
              boxShadow: "0 4px 24px oklch(0.55 0.16 210 / 0.35)",
            }}
          >
            <div className="flex items-center gap-4">
              <div
                ...
                style={{
                  background:
                    "linear-gradient(135deg, oklch(0.62 0.18 210), oklch(0.52 0.22 280))",
                  boxShadow: "0 4px 12px oklch(0.62 0.18 210 / 0.5)",
                }}
              >
              ...
              <div className="flex-1 min-w-0">
                ...
                <p
                  className="text-sm mt-0.5"
                  style={{ color: "oklch(0.72 0.08 220)" }}
                >
                  {currentUser.gender === "male"
                    ? "Connect with a female user"
                    : "Connect with a male user"}
                </p>
              </div>
              <svg
                aria-hidden="true"
