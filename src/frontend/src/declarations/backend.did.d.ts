...
export type MessageType = { 'audio' : Uint8Array } |
  { 'text' : string };
export type Time = bigint;
export interface UserProfile { 'username' : string, 'createdAt' : Time }
...
export interface _SERVICE {
  ...
  'sendMessage' : ActorMethod<[Principal, MessageType], string>,
}
